...
The maintainer describes what they want in natural language. Interpret the request and act. Examples:
...
5. **Apply the outcome:**
   ...
   - `wontfix` (enhancement) — write to out-of-scope documentation, link to it from a comment, then close.
